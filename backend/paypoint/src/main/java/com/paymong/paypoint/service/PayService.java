...
public class PayService {
    public String getMap(String brand){
    ...
    private String isCafe(String brand){
    ...
    private String isCombeni(String brand) {
    ...
    private String isSingPc(String brand){
    ...
    private String isBurger(String brand){
    ...
    private String isMovie(String brand){
    ...
    private String isShop(String brand){
    ...
    private String isDelvery(String brand){
    ...
    private String isBreadIce(String brand){
