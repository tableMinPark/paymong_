package com.paymong.collect.global.security;
...
public class TokenAuthenticationFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse response, FilterChain chain) throws RuntimeException, ServletException, IOException {
        ...
        if (internalToken != null) {
            ...
            log.info("TokenAuthenticationFilter : Collect 서비스 AccessToken 으로 접근 : {} : {} : {}", memberId, userDetails.getAuthorities(), internalToken);
        }
